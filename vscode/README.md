...
Visual studio code plugin containing Bootstrap 5 snippets.
...
1. Install plugin
  - Press `F1`, paste `ext install bootstrap5-vscode` & then press `enter` (or)
...
## Documentation
Here are available snippets (WIP, currently updating to BS5 from the older BS4 version)
...
## License
Bootstrap 5 Snippets - Visual studio code plugin is open-sourced software licensed under the [MIT license](http://opensource.org/licenses/MIT).
